...
class Config(object):
    ...
    START_IMG = os.environ.get("START_IMG", "https://telegra.ph/file/68a7ca5269cc0144832af.jpg")
    CMD_IMG = os.environ.get("CMD_IMG", "https://telegra.ph/file/68a7ca5269cc0144832af.jpg")
